...
import (
	...
	"github.com/apinprastya/cmd/harness"
	"github.com/apinprastya/modules/testrunner/app/controllers"
...
For example, to run the booking sample application's tests:
    ...
    revel test github.com/apinprastya/samples/booking dev
...
func testApp(args []string) {
	...
	for _, module := range revel.Modules {
		if module.ImportPath == revel.Config.StringDefault("module.testrunner", "github.com/apinprastya/modules/testrunner") {
...
You can add it to a run mode configuration with the following line:
	...
	module.testrunner = github.com/apinprastya/modules/testrunner
